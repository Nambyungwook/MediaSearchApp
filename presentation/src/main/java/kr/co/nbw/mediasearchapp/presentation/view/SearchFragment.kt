...
import kr.co.nbw.mediasearchapp.presentation.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment(), OnNextPageCallListener, OnFavoriteMediaItemClick {
    ...
    private fun setupRecyclerView() {
        ...
        searchMediasAdapter.setOnItemClickListener { mediaEntity ->
            val intent = Intent(this.context, MediaActivity::class.java)
            intent.putExtra(EXTRA_MEDIA_DATA_KEY, mediaEntity.toMediaUiModel())
